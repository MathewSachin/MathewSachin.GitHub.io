...
If you're setting up a Jekyll blog from scratch, you might also want to look at {% include post_link.html url="/blog/2026/03/12/ditching-disqus-for-giscus" text="my post on switching to giscus" %} — swapping out the comment system was another quick win that made the blog faster and more privacy-friendly.
