...
*If you're running a Jekyll blog and want to dig into the full implementation, the source is on {% include post_link.html url="/blog/2026/04/01/pr-preview-setup" text="GitHub" %}. Drop a question in the comments if anything's unclear.*
