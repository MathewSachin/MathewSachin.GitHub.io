...
{% picture hero mistral-forge-hero.svg alt="Pipeline visualization showing raw document data flowing into a Mistral Forge furnace, then emerging as a glowing custom AI model, with enterprise partner names ASML, Ericsson, ESA listed below" %}
