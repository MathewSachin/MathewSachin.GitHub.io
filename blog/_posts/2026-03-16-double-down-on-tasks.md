...
{% picture hero double-down-tasks-hero.svg alt="Blackjack table showing a highlighted priority task card with a 2× chip and task list, representing the concept of doubling down on your most important work" %}
...
<div class="alert alert-info">
  ⏰ <b>Try this:</b> Before opening any communication apps in the morning, spend 25 minutes on your most important task. Just 25 minutes. The goal is to break the habit of starting your day by reacting to other people's priorities.
</div>
...
<div class="alert alert-info">
  🔕 <b>The test:</b> If you can be interrupted, you will be. If you make interruption structurally difficult, you probably won't. The goal isn't discipline — it's design.
</div>
...
1. **Tonight**, write down the one task that would make tomorrow a success.
2. **Tomorrow morning**, before anything else, set a 25-minute timer and work only on that task.
3. **After 25 minutes**, ask: is this the most important use of the next hour? If yes, keep going. If not, make a deliberate decision to switch.
4. **Before you leave for the day**, write a two-sentence note on where you got to and what the next concrete action is.

That's it. No productivity system overhaul, no new app. Just four small behaviours applied consistently.

<div class="alert alert-info">
  💡 <b>The insight:</b> Doubling down isn't a technique you apply once. It's a habit you build through repetition. The first few times you sit through the discomfort of a hard task instead of escaping, it gets slightly easier. After a few weeks, sustained focus starts to feel normal.
</div>
