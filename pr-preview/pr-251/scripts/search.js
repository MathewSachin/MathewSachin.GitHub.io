import { create, load, search } from '/pr-preview/pr-251/scripts/orama.js';
import { escapeHtml } from '/pr-preview/pr-251/scripts/utils.js';
...
const BASE_PATH = '/pr-preview/pr-251';
...
async function initIndex() {
  try {
    const resp = await fetch('/pr-preview/pr-251/search-index.json');
