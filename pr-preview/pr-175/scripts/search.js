import { create, load, search } from '/pr-preview/pr-175/scripts/orama.js';
...
const BASE_PATH = '/pr-preview/pr-175';
...
async function initIndex() {
  try {
    const resp = await fetch('/pr-preview/pr-175/search-index.json');
