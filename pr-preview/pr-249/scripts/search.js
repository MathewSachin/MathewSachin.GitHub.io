import { create, load, search } from '/pr-preview/pr-249/scripts/orama.js';
import { escapeHtml } from '/pr-preview/pr-249/scripts/utils.js';
...
const BASE_PATH = '/pr-preview/pr-249';
...
async function initIndex() {
  try {
    const resp = await fetch('/pr-preview/pr-249/search-index.json');
