import { create, load, search } from '/pr-preview/pr-252/scripts/orama.js';
import { escapeHtml } from '/pr-preview/pr-252/scripts/utils.js';
...
const BASE_PATH = '/pr-preview/pr-252';
...
async function initIndex() {
  try {
    const resp = await fetch('/pr-preview/pr-252/search-index.json');
