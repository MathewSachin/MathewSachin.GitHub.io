import { create, load, search } from '/pr-preview/pr-254/scripts/orama.js';
import { escapeHtml } from '/pr-preview/pr-254/scripts/utils.js';
...
const BASE_PATH = '/pr-preview/pr-254';
...
async function initIndex() {
  try {
    const resp = await fetch('/pr-preview/pr-254/search-index.json');
