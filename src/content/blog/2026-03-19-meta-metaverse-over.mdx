...
related:
  ...
  - 2026-03-17-gemini-gems
  - 2026-03-18-mistral-forge-enterprise-ai
---
import { getPostByUrl } from '@utils/posts';
import metaMetaverseOverHero from '@images/meta-metaverse-over-hero.svg';
...
<Picture src={metaMetaverseOverHero} alt="A virtual horizon fading into darkness, representing the end of Meta's Metaverse vision" />
