...
---
import natureVibeCodeHero from '@images/nature-vibe-code-hero.svg';
...
<Picture src={natureVibeCodeHero} alt="Conceptual illustration showing nature's vibe coding: a speech bubble prompt on the left, a DNA double helix in the center, and a human silhouette as the output on the right" />
