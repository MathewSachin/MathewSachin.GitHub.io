...
description: "Guarantee a safe first click — every time — by controlling which numbers the browser considers \"random\". Teaches: monkey-patching Math.random, prototype overrides."
icon: "fas fa-bomb"
...
*Enjoyed this? Check out <PostLink post={getPostByUrl('/blog/2016/11/05/chrome-dino-hack')} />, <PostLink post={getPostByUrl('/blog/2026/03/20/hacking-typeracer')} />, or <PostLink post={getPostByUrl('/blog/2026/03/07/hacking-wordle')} /> for more fun browser tricks.*
