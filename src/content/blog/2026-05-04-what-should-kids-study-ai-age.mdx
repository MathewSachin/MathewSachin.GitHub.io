...
| **Persuasion and leadership** | Getting humans to act, inspiring change, building organisations |
...
This applies to software, to economies, to ecosystems, to social organisations. People who think in systems make fewer naïve predictions and ask better questions about second-order effects. The concepts can be taught without requiring children to write production code.
...
Not as an abstract philosophy course — as applied reasoning about real situations. How do you decide what is fair when interests conflict? How do you evaluate a source? How do you recognise when you are being manipulated? What do you do when following the rules produces a bad outcome?
...
This is an uncomfortable message for educational optimisers. It may nonetheless be correct.
...
The one thing we can say with confidence: preparing children to thrive in 2040 by optimising their education for 2015 is a plan that is already failing.
