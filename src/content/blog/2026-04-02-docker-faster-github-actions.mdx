...
*If you're also running a Jekyll site on GitHub Actions with custom plugins, the <PostLink post={getPostByUrl('/blog/2026/04/01/pr-preview-setup')} /> is worth reading alongside this one — together they cover the full CI pipeline this site uses.*
