...
description: "Set an immortal dino, freeze the score counter, and get a free high score in one console command. Teaches: JS objects, property assignment, the Console tab."
icon: "fas fa-gamepad"
tags: [chrome, hack, game, browser, javascript, devtools]
related:
  - 2026-03-07-hacking-wordle
  - 2026-03-20-hacking-minesweeper-online
  - 2026-03-20-hacking-typeracer
...
import ChromeDinoSpeedWidget from '@components/blog/ChromeDinoSpeedWidget.svelte';
import ChromeDinoScoreWidget from '@components/blog/ChromeDinoScoreWidget.svelte';
import ChromeDinoJumpWidget from '@components/blog/ChromeDinoJumpWidget.svelte';
import ChromeDinoElevationWidget from '@components/blog/ChromeDinoElevationWidget.svelte';
import Tabs from '@components/Tabs.astro';
import TriviaChallenge from '@components/TriviaChallenge.svelte';
    ...
    >
      ...
      <div slot="mobile">
        <AlertInfo>
          ...
          👉 <PostLink post={getPostByUrl('/blog/2026/03/19/chrome-dino-hack-mobile-bookmarklet')} />
        </AlertInfo>
...
<ChromeDinoSpeedWidget client:load />
...
<ChromeDinoScoreWidget client:load />
...
<ChromeDinoJumpWidget client:load />
...
<ChromeDinoElevationWidget client:load />
...
👉 Check out the full blog post (<PostLink post={getPostByUrl('/blog/2026/03/14/chrome-dino-autoplay')} />) to get the perfect, unbeatable version.
...
## 🦕 Chrome Dino Trivia Challenge

Think you know your Dino game lore? Put your knowledge to the test!

<TriviaChallenge
  client:load
  storageKey="chrome-dino-trivia-highscore"
  questions={[
    {
      question: "What is the default starting speed of the Chrome Dino game?",
      options: ["3", "6", "10", "15"],
      answer: 1
    },
    {
      question: "Which keyboard key starts the Chrome Dino game?",
      options: ["Enter", "Shift", "Space", "Tab"],
      answer: 2
    },
    {
      question: "At approximately how many points do pterodactyls first appear?",
      options: ["100", "250", "450", "800"],
      answer: 2
    },
    {
      question: "What JavaScript method is called to replace the game-over behavior in the God Mode hack?",
      options: ["Runner.prototype.start", "Runner.prototype.gameOver", "Runner.prototype.stop", "Runner.prototype.reset"],
      answer: 1
    },
    {
      question: "What is the default hard-coded ground Y position (in pixels) used by the Chrome Dino game?",
      options: ["50", "75", "93", "120"],
      answer: 2
    }
  ]}
/>
...
Time to try some other great hacks — <PostLink post={getPostByUrl('/blog/2026/03/07/hacking-wordle')} />, <PostLink post={getPostByUrl('/blog/2026/03/20/hacking-minesweeper-online')} />, <PostLink post={getPostByUrl('/blog/2026/03/20/hacking-typeracer')} />.
