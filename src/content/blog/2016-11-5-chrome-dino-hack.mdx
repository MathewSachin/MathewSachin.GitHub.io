...
Use the sliders and input box to tweak the game in real-time, or the Console text-box to paste the code snippets for more advanced hacks. The game above will update instantly as you make changes!
...
Want to put the pedal to the metal? Or maybe slow things down for a relaxing run? The game normally starts at a speed of around **6** and gradually increases as your score climbs.
