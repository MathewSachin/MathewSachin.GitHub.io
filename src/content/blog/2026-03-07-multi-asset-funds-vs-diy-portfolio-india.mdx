...
highlight: false
---
import multiAssetVsDiyHero from '@images/multi-asset-vs-diy-hero.svg';
...
<Picture src={multiAssetVsDiyHero} alt="Balance scale comparing a Multi-Asset Fund with a pie chart showing 60% equity, 20% debt, 20% gold on one side, versus a DIY Portfolio with separate equity, debt, and gold fund icons on the other — for Indian investors" />
