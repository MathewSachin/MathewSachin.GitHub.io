...
description: "Write posts on your phone with GitHub Copilot and have them live in minutes without ever touching a laptop. Teaches: GitHub Copilot as editor, PRs as a publishing pipeline, GitHub Pages automation."
icon: "fas fa-robot"
...
If you're setting up a Jekyll blog from scratch, you might also want to look at <PostLink post={getPostByUrl('/blog/2026/03/12/ditching-disqus-for-giscus')} /> — swapping out the comment system was another quick win that made the blog faster and more privacy-friendly.
