...
If you're setting up a Jekyll blog from scratch, you might also want to look at <PostLink slug="2026-3-12-ditching-disqus-for-giscus" /> — swapping out the comment system was another quick win that made the blog faster and more privacy-friendly.
