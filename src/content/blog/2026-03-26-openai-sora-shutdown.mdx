...
Compare that to how Meta handled the failure of the metaverse: <PostLink post={getPostByUrl('/blog/2026/03/19/meta-metaverse-over')} />. You can trace the failure in public. OpenAI's Sora dies without a record.
