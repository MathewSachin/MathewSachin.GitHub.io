...
description: "Finish a TypeRacer race at a perfectly human 85 WPM without typing more than one key yourself. Teaches: async automation, timing jitter, DOM input simulation."
...
*Enjoyed this? Check out <PostLink post={getPostByUrl('/blog/2016/11/05/chrome-dino-hack')} /> or <PostLink post={getPostByUrl('/blog/2026/03/07/hacking-wordle')} /> for more fun browser tricks.*
