...
<div class="alert alert-info">
  ...
  👉 <PostLink slug="2026-3-19-hacking-wordle-mobile-bookmarklet" />
</div>
...
*Want more browser tricks like this? Check out <PostLink slug="2016-11-5-chrome-dino-hack" /> for more fun ways to bend the web to your will, or try <PostLink slug="2026-3-7-edit-webpage-inspect-element" /> to see another clever DevTools trick!*
