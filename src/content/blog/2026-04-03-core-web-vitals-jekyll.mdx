...
<img alt="Google Search Console Core Web Vitals report showing all metrics in the Good range after improvements" src="/images/core-web-vitals-good.svg" width="720" style="display:block;margin:1rem auto;" />
