...
description: "Go from 'Needs improvement' to Good on all three Core Web Vitals. Teaches: jekyll-picture-tag, Rouge vs highlight.js, Pintora at build time, build-time TOC, HTML minification, and custom AdSense placement."
...
import coreWebVitalsGood from '@images/core-web-vitals-good.svg';
...
<Picture src={coreWebVitalsGood} alt="Google Search Console Core Web Vitals report showing all metrics in the Good range after improvements" />
...
```liquid
<BlogImage src="post-image.png" alt="Description" />
```
...
*If you found this useful and want to dig into any of these implementations, the full build pipeline is covered in the <PostLink post={getPostByUrl('/blog/2026/04/02/docker-faster-github-actions')} />. Questions welcome in the comments.*
