...
---
import quoraDevtoolsHero from '@images/quora-devtools-hero.svg';
...
<Picture src={quoraDevtoolsHero} alt="Stylised illustration of a red Quora Q logo being scanned by a green digital magnifying glass, with lines of code breaking through a blurry overlay — representing browser DevTools bypassing Quora's login wall." />
