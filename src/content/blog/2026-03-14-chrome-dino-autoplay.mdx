...
description: "Write a bot that plays the Dino game indefinitely — zero keystrokes from you after launch. Teaches: setInterval, event dispatching, reading live game state."
...
We store the return value in `autoPlay` so we can stop the bot later.
...
*This auto-play script is just one of many tricks you can pull off in the Chrome Dino game. Check out <PostLink post={getPostByUrl('/blog/2016/11/05/chrome-dino-hack')} /> for god mode, speed tweaks, score manipulation, and more!*
