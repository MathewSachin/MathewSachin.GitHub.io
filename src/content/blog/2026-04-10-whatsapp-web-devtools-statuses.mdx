...
---
import whatsappDevtoolsHero from '@images/whatsapp-devtools-hero.svg';
...
<Picture src={whatsappDevtoolsHero} alt="Isometric illustration of a magnifying glass inspecting a glowing browser tab, revealing green source code underneath. DevTools panels show Network and Elements tabs with WhatsApp media entries highlighted in teal." />
