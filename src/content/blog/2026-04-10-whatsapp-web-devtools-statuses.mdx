...
- <PostLink post={getPostByUrl('/blog/2026/03/22/instagram-story-sniper')} /> — downloads disappearing Stories by reading React's internal fiber tree
- <PostLink post={getPostByUrl('/blog/2026/03/21/save-instagram-photos')} /> — removes Instagram's right-click block with a MutationObserver
- <PostLink post={getPostByUrl('/blog/2026/03/21/twitter-x-video-sniper')} /> — captures HLS streams that never appear as a single file in the Network tab
