...
This blog exists precisely because of the dynamic the post describes. <PostLink slug="2026-03-12-ai-blog-generation-flow" /> — content published to a domain I control, with no algorithm deciding who sees it, no platform that can shadow-ban a post or change the rules about links.
