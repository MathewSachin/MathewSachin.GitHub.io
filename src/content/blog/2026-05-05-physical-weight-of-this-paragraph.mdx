...
*This post was generated with the assistance of AI as part of an <PostLink url="/blog/2026/03/12/ai-blog-generation-flow" text="automated blogging experiment" />. The irony of using an AI to write an article about the cost of using AI is noted, and intentional.*
