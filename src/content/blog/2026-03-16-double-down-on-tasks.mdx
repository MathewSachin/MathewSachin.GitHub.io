...
---
import doubleDownTasksHero from '@images/double-down-tasks-hero.svg';
...
<Picture src={doubleDownTasksHero} alt="Blackjack table showing a highlighted priority task card with a 2× chip and task list, representing the concept of doubling down on your most important work" />
