...
Once you have the raw mixed audio data, you can pipe it to FFmpeg for encoding — see <PostLink post={getPostByUrl('/blog/2017/07/28/ffmpeg-pipe-csharp')} /> for how to do that.
