...
Once you have the raw mixed audio data, you can pipe it to FFmpeg for encoding — see <PostLink url="/blog/2017/07/28/ffmpeg-pipe-csharp" text="my C# FFmpeg piping post" /> for how to do that.
