...
So, usually the recommendation is to [keep these functions pure](/blog/2023/04/02/pure-functions.html), basically only rely on inputs to produce output, don't cause side-effects.
