...
description: "Make any website say whatever you want in about ten seconds — great for pranks. Teaches: the DOM, <code>document.designMode</code>."
...
import DesignModeWidget from '@components/blog/DesignModeWidget.svelte';
...
Want to take your DevTools skills further? Check out <PostLink post={getPostByUrl('/blog/2026/03/07/hacking-wordle')} /> for another fun trick you can pull off with the same panel.
