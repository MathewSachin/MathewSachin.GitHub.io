...
description: "Twitter/X has never offered a download button. This script captures any playing video. Teaches: HLS stream identification, MediaSource API basics, blob URL capture."
icon: "fab fa-twitter"
accent_color: "#1D9BF0"
...
The original <PostLink url="/blog/2026/03/21/youtube-shorts-sniper" text="YouTube Shorts Sniper" /> introduced the Delta-Check to detect a loop restart — because Shorts loop by default and never fire `ended`. The <PostLink url="/blog/2026/03/21/instagram-reel-sniper" text="Instagram Reel Sniper" /> used the simpler `video.onended`, because Reels play exactly once and then stop cleanly.
...
*Using the same browser-only approach, you can also <PostLink url="/blog/2026/03/22/reddit-video-sniper" text="download Reddit videos" />, <PostLink url="/blog/2026/03/21/instagram-reel-sniper" text="download Instagram Reels" />, <PostLink url="/blog/2026/03/21/youtube-shorts-sniper" text="download YouTube Shorts" />, and <PostLink url="/blog/2026/03/21/save-instagram-photos" text="save Instagram photos" />.*
