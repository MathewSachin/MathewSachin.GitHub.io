...
description: "Force any website into dark mode in two seconds on both desktop and mobile. Teaches: CSS filter injection, invert(), hue-rotate(), the <style> injection pattern."
icon: "fas fa-moon"
...
---
import BruteDarkModeWidget from '@components/blog/BruteDarkModeWidget.svelte';
...
<BruteDarkModeWidget client:load />
...
<div class="alert alert-info">
  💡 <b>New to bookmarklets?</b> See <a href="/blog/2026/03/19/chrome-dino-hack-mobile-bookmarklet.html">Hack the Chrome Dino on Mobile</a> for a detailed walkthrough of how to create and trigger bookmarklets on iOS and Android.
</div>
...
Want more browser hacks you can pull off without installing anything? Check out <PostLink url="/blog/2026/03/07/edit-webpage-inspect-element" text="Edit Any Webpage in Seconds" /> and <PostLink url="/blog/2026/03/07/hacking-wordle" text="Hacking Wordle with DevTools" />.
