...
Want more browser hacks you can pull off without installing anything? Check out <PostLink post={getPostByUrl('/blog/2026/03/07/edit-webpage-inspect-element')} /> and <PostLink post={getPostByUrl('/blog/2026/03/07/hacking-wordle')} />.
