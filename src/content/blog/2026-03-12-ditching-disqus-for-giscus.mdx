...
*If you want to streamline the rest of your Jekyll workflow too, check out <PostLink url="/blog/2026/03/12/ai-blog-generation-flow" text="my AI blog generation post" /> — it's the other half of keeping this blog low-friction.*
