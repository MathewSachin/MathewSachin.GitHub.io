...
![DevTools Network tab with Fetch/XHR filter active. The file 2026-04-08.json is selected in the left panel. The Preview tab on the right shows the JSON response including clue, spangram, themeWords and more fields.](/images/nyt-strands-network-tab.png)
