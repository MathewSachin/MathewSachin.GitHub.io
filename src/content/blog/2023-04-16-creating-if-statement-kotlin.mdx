...
The lambda blocks here work best when kept [pure](/blog/2023/04/02/pure-functions.html) — side-effect-free functions that only compute their result — making the construct easy to reason about and test.
