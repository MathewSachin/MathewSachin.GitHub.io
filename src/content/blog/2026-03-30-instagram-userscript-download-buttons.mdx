...
*The three earlier Instagram posts — <PostLink slug="2026-3-21-save-instagram-photos" />, <PostLink slug="2026-3-21-instagram-reel-sniper" />, and <PostLink slug="2026-3-22-instagram-story-sniper" /> — each require you to open the browser console, paste a snippet, and press Enter every single time you want to save something. This post bundles all three techniques into one persistent userscript that injects a **⬇ button** directly into the Instagram UI — no console, no paste, no repeat setup.*
...
*For the individual console-based versions of each technique, see <PostLink slug="2026-3-21-save-instagram-photos" />, <PostLink slug="2026-3-21-instagram-reel-sniper" />, and <PostLink slug="2026-3-22-instagram-story-sniper" />. You can also <PostLink slug="2026-3-22-reddit-video-sniper" /> and <PostLink slug="2026-3-21-youtube-shorts-sniper" /> with the same browser-only approach.*
