...
The <PostLink slug="2016-11-5-chrome-dino-hack" /> rely on the Chrome Developer Console to run JavaScript. On a desktop that's one keyboard shortcut away, but on a phone or tablet the console simply isn't available. That's where **bookmarklets** come in.
...
Want to go further? Check out the full <PostLink slug="2016-11-5-chrome-dino-hack" /> for speed control, score manipulation, auto-play, and more tricks you can use on desktop!
