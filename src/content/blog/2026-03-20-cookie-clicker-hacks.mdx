...
*Enjoyed this? Check out <PostLink post={getPostByUrl('/blog/2016/11/05/chrome-dino-hack')} />, <PostLink post={getPostByUrl('/blog/2026/03/20/hacking-minesweeper-online')} />, or <PostLink post={getPostByUrl('/blog/2026/03/20/hacking-typeracer')} /> for more browser tricks.*
