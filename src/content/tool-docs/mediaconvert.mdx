...
description: "Convert video and audio files between MP4, WebM, MKV, MOV, MP3, WAV, OGG, FLAC and more — runs entirely in your browser using the WebCodecs API. No uploads, no server."
icon: "fas fa-film"
quick_tool: true
listed: true
published: true
