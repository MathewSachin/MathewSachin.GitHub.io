---
title: "Captura Web Recorder"
description: "Record your screen with webcam overlay and microphone audio — streams directly to disk. Runs entirely in your browser, no data sent to any server."
icon: "fas fa-video"
quick_tool: true
listed: true
published: true
...
Built-in on-screen annotation tools let you draw freehand, highlight regions, and zoom into
specific screen areas live while recording so you can produce tutorial-style recordings
